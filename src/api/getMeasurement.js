 ...
 **/
export default async function (latitude, longitude, distance = 100) {
  try {
    return fetch(`https://api.safecast.org/measurements.json?distance=${distance}&latitude=${latitude}&longitude=${longitude}`)
